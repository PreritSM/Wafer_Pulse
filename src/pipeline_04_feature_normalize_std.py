...
def feature_scaling(config):
    ...
    """
    csv_path = os.path.join(config['data_preparation']['preprocessed_data_dir'], "preprocessed_secom_data.csv")
    ...
    df_scaled['Output'] = y
    out_path = os.path.join(config['data_preparation']['preprocessed_data_dir'], "scaled_secom_data.csv")
